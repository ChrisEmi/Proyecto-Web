export const datosActividades = {
  deportivas: {
    ...
    items: [
      {
        ...
        titulo: "Fútbol",
        descripcion:
          "Se parte experiencias unicas con nosotros en el equipo de fútbol oficial de la ESCOM, y representa los colores de nuestra institución.",
        horarios: [
        ...
        colorFondo: "bg-white border-2 border-escom-200",
        colorTexto: "text-escom-800",
      },
      {
        icono: "fa-solid fa-volleyball",
        titulo: "Voleibol",
        descripcion:
          "Se parte experiencias unicas con nosotros en el equipo de voleibol oficial de la ESCOM, y representa los colores de nuestra institución.",
        horarios: [
      ...
      },
      {
        ...
        titulo: "Clubes",
        descripcion:
          "Los clubes son espacios de convivencia y aprendizaje donde puedes desarrollar tus habilidades y conocer a personas con intereses similares.",
        lista: [
          "Club de Ajedrez",
          "Club de Robótica",
    ...
    estilos: {
      contenedor: "bg-white",
      presentacion: "bg-gradient-to-br from-escom-200 to-white",
      boton: "bg-white text-escom-700 hover:bg-escom-50",
      textoTitulo: "text-escom-800",
      textoDescripcion: "text-escom-800/90",
      textoSubtitulo: "text-escom-200",
    },
  },
  culturales: {
    id: "culturales",
    ...
    items: [
      ...
      },
      {
        ...
        horarios: [{ dia: "Jueves", hora: "12:00 - 19:00" }],
        profesor: "Prof. Hugo Hernández Vera",
        colorFondo: "bg-escom-600",
        colorTexto: "text-white",
      },
      ...
      },
      {
        ...
        descripcion:
          "Los clubes son espacios de convivencia y aprendizaje donde puedes desarrollar tus habilidades y conocer a personas con intereses similares.",
        lista: ["Tuna ESCOM", "Algoritmo de baile", "Anime"],
        colorFondo: "bg-escom-600",
        colorTexto: "text-white",
      },
    ],
    ...
    estilos: {
      contenedor: "bg-escom-700",
      presentacion: "bg-gradient-to-br from-escom-600 to-escom-700",
      boton: "bg-white text-escom-700 hover:bg-escom-50",
      textoTitulo: "text-white",
      textoDescripcion: "text-white/90",
      textoSubtitulo: "text-escom-200",
    },
  },
};
