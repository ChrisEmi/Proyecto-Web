    ...
    return (
        <>
            ...
            <div 
                ...
                `}
            >
                <button className="hidden md:block absolute top-1/2 -right-5 bg-escom-sombra-400 rounded-full py-2 px-3 cursor-pointer" onClick={sidebarOpens}>
            ...
            <div className={`flex flex-col items-center border-b border-escom-100 px-10 ${esAbierto ? '' : 'p-3'}`}>
                ...
                />
                {esAbierto && (
                    <h1 className="text-2xl md:text-2xl font-bold text-center pb-5 titulo-sidebar">
                        Panel de Alumno
                    </h1>
                )}
            </div>
