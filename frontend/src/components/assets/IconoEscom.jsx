export const IconoEscom = ({ className, ...props }) => {
  return (
    <svg
      ...
      aria-hidden="true" // Es decorativo, así que lo ocultamos de lectores de pantalla
      
      // Aquí es donde "mágicamente" se aplican tus clases de Tailwind
      className={className}
      {...props}
    >
      <g
        transform="translate(0.000000,139.000000) scale(0.100000,-0.100000)"
        fill="currentColor" // <-- Esto es lo que permite que "text-escom-500" funcione
        stroke="none"
      >
